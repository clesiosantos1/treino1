    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-danger">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="index.php">Cadastrar cliente<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
        ...
        <form method="POST" action="processa.php">
            ...
            <div class="mb-3">
                <input type="text" class="form-control" id="exampleInputPassword1" name="filiação"
                    placeholder="Filiação Ex: pai e mãe">
            </div>
            <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" name="data" id="exampleInputPassword1">
                                </div>
